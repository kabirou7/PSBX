...
author: "Kanlanfeyi Kabirou, Hounssinou Jordy"
output: pdf_document
---
...
*Comment mesurer la performance de nos algorithmes?*  
Nous utiliserons dans notre cas la matrice de confusion qui est très utilisée en apprentissage supervisé pour évaluer la performances d'un modèle de classification. Dans cette matrice, les lignes correspondent aux nombres d'instances réelles et les colones le nombre d'instances prédites.
